    ...
    printText: function (text, opts) {
        ...
        return new Promise(function (resolve, reject) {
            if (Platform.OS === "ios") {
                ...
                RNBLEPrinter.printRawData(processedText.text, processedText.opts, // TODO: Success callback for iOS
                function (error) {
                    console.warn(error);
                    reject(error);
                });
    ...
    printBill: function (text, opts) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (Platform.OS === "ios") {
                ...
                RNBLEPrinter.printRawData(billTo64Buffer(text, opts), function () { return resolve(); }, function (error) {
                    console.warn(error);
                    reject(error);
                });
            }
    ...
    printRaw: function (text) {
        return new Promise(function (resolve, reject) {
            if (Platform.OS === "ios") {
                ...
                RNBLEPrinter.printRawData(text, function () { return resolve(); }, function (error) {
                    console.warn(error);
                    reject(error);
                });
            }
    ...
    printColumnsText: function (texts, columnWidth, columnAlignment, columnStyle, opts) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (Platform.OS === "ios") {
                ...
                RNBLEPrinter.printRawData(textTo64Buffer(result, opts), function () { return resolve(); }, function (error) {
                    console.warn(error);
                    reject(error);
                });
            }
